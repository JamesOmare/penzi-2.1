...
app.config["SQLALCHEMY_DATABASE_URI"] = 'postgresql://james:foxtrot09er@localhost/penzi_2'
...
@app.route("/post_start_Outgoinging_message", methods=["POST"])
def post_start():
    message_data = request.get_json()
    ...
    message_m = Outgoing_Message(
        ...
        sender_number = message_data.get("sender_number"),
        message_start = message_data.get("message_start"),
        shortcode = message_data.get("shortcode")
...
@app.route("/post_details_Outgoinging_message", methods=["POST"])
def post_details():
    message_data = request.get_json()
    ...
    message_m = Outgoing_Message(
        ...
        sender_number = message_data.get("sender_number"),
        message_details = message_data.get("message_details"),
        shortcode = message_data.get("shortcode")
...
@app.route("/post_myself_Outgoing_message", methods=["POST"])
def post_myself_message():
    message_data = request.get_json()
    ...
    message_m = Outgoing_Message(
        ...
        sender_number = message_data.get("sender_number"),
        message_myself = message_data.get("message_myself"),
        shortcode = message_data.get("shortcode")
...
@app.route("/post_match_Outgoing_message", methods=["POST"])
def post_match_message():
    ...
    message_m = Outgoing_Message(
        ...
        sender_number = message_data.get("sender_number"),
        message_match = message_data.get("message_match"),
        shortcode = message_data.get("shortcode")
...
def get_message_start(sender_number):
    ...
    return data.get("message_start"), 200
...
#         shortcode = details_message.get("shortcode")
...
#         shortcode = myself_message.get("shortcode")
...
#         shortcode = match_message.get("shortcode")
